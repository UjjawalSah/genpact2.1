            ...
            <tbody>
                ...
                <tr>
                    <form action="modify.jsp" method="post">
                        ...
                        <td><input type="text" name="employee_name" value="<%= rs.getString("employee_name") %>"></td>
                        <td><input type="text" name="project" value="<%= rs.getString("project") %>"></td>
                        <td><input type="date" name="date_1" value="<%= rs.getString("date_1") %>"></td>
                        <td><input type="time" name="start_time" value="<%= rs.getString("start_time") %>"></td>
                        <td><input type="time" name="end_time" value="<%= rs.getString("end_time") %>"></td>
                        <td><input type="text" name="task_category" value="<%= rs.getString("task_category") %>"></td>
