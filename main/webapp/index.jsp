...
<head>
    ...
    <style>
        body {
            ...
            background-image: linear-gradient(to right top, #6f9de4, #0094c2, #008490, #0e705d, #365a34);
            margin: 0;
            padding: 0;
            display: flex;
        ...
        .container {
            ...
            background-image: linear-gradient(to right top, #adb1b8, #b5bec2, #c0caca, #cfd6d2, #dfe1db);
            padding: 20px;
            border-radius: 5px;
